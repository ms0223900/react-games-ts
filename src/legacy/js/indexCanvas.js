const canvasEl = document.querySelector("#indexMeal-canvas");
...
function Confetti() {
  ...
  const size = Math.random(5) * (w / 200);
...
function wheel() {
  ...
  if ($windowTop > $(".indexMeal").offset().top - 50) {
    $("#indexMeal-canvas").animate({ opacity: "1" }, 1000);
  }
}
