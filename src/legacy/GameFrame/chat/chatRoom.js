...
import { getChatByRoomId, socket } from '../../Gomoku/API'
import { makeStyles } from '@material-ui/styles';
import { scrollToBottom } from '../../Gomoku/fn';
...
const ChatRoom = ({ 
  ...
  const chatUsername = username ? username : userNow
  const roomId = userData && userData[0].roomId
  ...
  }, [userNow, chatData, userData, chatUsername])
  //
  useEffect(() => {
